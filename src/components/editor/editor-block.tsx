...
export function EditorBlock({ block, index }: Props) {
  ...
  return (
    <div className="editor-block group relative flex gap-2 rounded-lg border border-[var(--border)] bg-[var(--bg)] p-3 transition-all hover:border-[var(--text-secondary)]/30">
      {/* Drag handle */}
      <div className="flex flex-col items-center gap-1 pt-1 cursor-grab opacity-0 group-hover:opacity-100 transition-opacity">
